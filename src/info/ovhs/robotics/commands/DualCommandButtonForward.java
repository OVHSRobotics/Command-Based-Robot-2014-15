 ...
 *
 */
public class DualCommandButtonForward extends Command {
	
	Command command1 = new ConveyerMove(true);
	Command command2 = new RearMove(true);

    public DualCommandButtonForward() {
