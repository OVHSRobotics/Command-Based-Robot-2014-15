...
import info.ovhs.robotics.commands.activeinput.SpinCan;
...
public class OI {
    ...
    public void xboxControllerMappings() {
    	...
    	aButton.whileHeld(new RearMoveBack());
